        ...
        try {
            ...
            getAjax("https://nominatim.openstreetmap.org/reverse?lat=" + latitude + "&lon=" + longitude + "&format=json", function (data) {
                ...
                if (Boolean(country)) {
                    ...
                    var urlRedirectFinal = urlRedirect + "&endereco.cep=" + encodeURI(postCode) + "&rua=" +  encodeURI(road) + "&bairro="+  encodeURI(suburb) + "&cidade=" +  encodeURI(city) +"&appUserId="+ pushID + "&appPushToken=" + pushToken;
